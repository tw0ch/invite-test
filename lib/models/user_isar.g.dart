...
const UserIsarSchema = CollectionSchema(
  ...
  properties: {
    r'current_address': PropertySchema(
      id: 0,
      name: r'current_address',
...
void _userIsarSerialize(
  ...
  writer.writeString(offsets[0], object.currentAddress);
}
...
UserIsar _userIsarDeserialize(
  ...
  object.currentAddress = reader.readStringOrNull(offsets[0]);
  object.id = id;
  return object;
}
...
extension UserIsarQueryFilter
  ...
  QueryBuilder<UserIsar, UserIsar, QAfterFilterCondition>
      currentAddressIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
        property: r'current_address',
      ));
    });
  }

  QueryBuilder<UserIsar, UserIsar, QAfterFilterCondition>
      currentAddressIsNotNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<UserIsar, UserIsar, QAfterFilterCondition> currentAddressEqualTo(
    String? value, {
  ...
  QueryBuilder<UserIsar, UserIsar, QAfterFilterCondition> currentAddressBetween(
    String? lower,
    String? upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<UserIsar, UserIsar, QAfterFilterCondition> currentAddressMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension UserIsarQuerySortBy on QueryBuilder<UserIsar, UserIsar, QSortBy> {
  QueryBuilder<UserIsar, UserIsar, QAfterSortBy> sortByCurrentAddress() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'current_address', Sort.asc);
    });
  }

  QueryBuilder<UserIsar, UserIsar, QAfterSortBy> sortByCurrentAddressDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'current_address', Sort.desc);
    });
  }
}
...
extension UserIsarQuerySortThenBy
  ...
  QueryBuilder<UserIsar, UserIsar, QAfterSortBy> thenByCurrentAddress() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'current_address', Sort.asc);
    });
  }

  QueryBuilder<UserIsar, UserIsar, QAfterSortBy> thenByCurrentAddressDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'current_address', Sort.desc);
    });
  }
...
extension UserIsarQueryWhereDistinct
  ...
  QueryBuilder<UserIsar, UserIsar, QDistinct> distinctByCurrentAddress(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'current_address',
          caseSensitive: caseSensitive);
    });
  }
}
...
extension UserIsarQueryProperty
  ...
  QueryBuilder<UserIsar, String?, QQueryOperations> currentAddressProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'current_address');
    });
  }
}
